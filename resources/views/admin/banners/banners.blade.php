            ...
            <div class="card-body">
              <table id="banners" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$banner['alt']}}</td>
                  <td>
                    <a style="width: 120px;" title="Edit Banner" href="{{url('admin/add-edit-banner/'.$banner['id'])}}"><i class="fas fa-edit"></i></a> 
                    &nbsp;&nbsp;
                    <a style="width: 120px;" title="Delete Banner" href="javascript:void(0)" class="confirmDelete" record="banner" recordid="{{$banner['id']}}"<?php /*href="{{url('admin/delete-banner/'.$banner['id'])}}*/ ?>><i class="fas fa-trash"></i></a> 
                    &nbsp;&nbsp;
                    @if($banner['status']==1)
