            ...
            <div class="card-body">
              <table id="brands" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>{{$brand->name}}</td>
                  <td>
                    <a style="width: 120px;" title="Edit Brand" href="{{url('admin/add-edit-brand/'.$brand->id)}}"><i class="fas fa-edit"></i></a> 
                    &nbsp;&nbsp;
                    <a style="width: 120px;" title="Delete Brand" href="javascript:void(0)" class="confirmDelete" record="brand" recordid="{{$brand->id}}"<?php /*href="{{url('admin/delete-brand/'.$brand->id)}}*/ ?>><i class="fas fa-trash"></i></a> 
                    &nbsp;&nbsp;
                    @if($brand->status==1)
