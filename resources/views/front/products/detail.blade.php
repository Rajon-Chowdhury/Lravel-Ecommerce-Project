					...
					<div class="carousel-inner">
						<div class="item active">
							@foreach($productDetails['images'] as $image)
							 <a href="{{asset('images/product_images/medium/'.$image['image'])}}"> <img style="width:29%" src="{{asset('images/product_images/medium/'.$image['image'])}}" alt=""/></a>
							@endforeach 
						</div>
					</div>
					<!--
					...
					<div class="control-group">
						...
						<h4 class="getAttrPrice">
						   @if($discounted_price>0)
						    <del>Tk. {{$productDetails['product_price']}}</del> Tk. <font color="red">{{$discounted_price}}</font>
						   @else
									...
									<li class="span3">
										<div class="thumbnail">
											...
											<div class="caption">
												...
												<h4 style="text-align:center"><a class="btn" href="{{ url('product/'.$product['id']) }}"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">Tk.{{ $product['product_price'] }}</a></h4>
											</div>
										</div>
									</li>
									@endforeach
